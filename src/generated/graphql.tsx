...
export type LaunchDetailQuery = { __typename?: "Query" } & {
  launch?: Maybe<
 ...
 * });
 */
export function useLaunchDetailQuery(
  baseOptions?: Apollo.QueryHookOptions<
    LaunchDetailQuery,
    LaunchDetailQueryVariables
  >
) {
  return Apollo.useQuery<LaunchDetailQuery, LaunchDetailQueryVariables>(
    LaunchDetailDocument,
    baseOptions
  );
}
export function useLaunchDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    LaunchDetailQuery,
    LaunchDetailQueryVariables
  >
) {
  return Apollo.useLazyQuery<LaunchDetailQuery, LaunchDetailQueryVariables>(
    LaunchDetailDocument,
    baseOptions
  );
}
export type LaunchDetailQueryHookResult = ReturnType<
  typeof useLaunchDetailQuery
>;
export type LaunchDetailLazyQueryHookResult = ReturnType<
  typeof useLaunchDetailLazyQuery
>;
export type LaunchDetailQueryResult = Apollo.QueryResult<
  LaunchDetailQuery,
  LaunchDetailQueryVariables
>;
